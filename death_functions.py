...
def kill_player(player):
    ...
    return 'You died!', GameStates.PLAYER_DEAD # Send message you died to the dead function in game_states

# Call this function if monster is killed on a turn
def kill_monster(monster):
    death_message = '{0} is dead!'.format(monster.name.capitalize()) # Show that monster is dead
